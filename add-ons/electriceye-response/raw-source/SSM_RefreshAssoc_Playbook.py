    ...
    for findings in securityHubEvent:
        ...
        for resources in findings['Resources']:
            ...
            if findingOwner != masterAccountId:
                ...
                try:
                    # use ssm send command to refresh association
                    response = ssm.send_command(
                        InstanceIds=[ ec2InstanceId ],
                        DocumentName='AWS-RefreshAssociation',
                        DocumentVersion='$LATEST',
                        TimeoutSeconds=360,
                        Comment='Association refresh launched by ElectricEye response playbook',
                    ...
                    try:
                        response = securityhub.update_findings(
                            ...
                            Note={'Text': 'Run Command was sent to invoke the AWS-RefreshAssociation document for the instance and the finding was archived. Re-run Electric Eye or view the Run Command execution list in the account that the Command was sent to to ensure it was successfully executed.','UpdatedBy': lambdaFunctionName},
