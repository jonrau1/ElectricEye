    ...
    for findings in securityHubEvent:
        ...
        for resources in findings['Resources']:
            ...
            if findingOwner != masterAccountId:
                ...
                try:
                    # put private bucket ACL
                    response = s3.put_bucket_acl(ACL='private',Bucket=s3BucketName)
                    try:
                        response = securityhub.update_findings(
                            Filters={'Id': [{'Value': findingId,'Comparison': 'EQUALS'}]},
                            Note={'Text': 'A private ACL was put on this bucket to remove public read or write access and the finding was archived. The bucket and account level access policies should be reviewed for any other instance of public or other unauthorized access being granted.','UpdatedBy': lambdaFunctionName},
