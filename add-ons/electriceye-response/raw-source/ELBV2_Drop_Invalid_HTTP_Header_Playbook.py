                ...
                try:
                    ...
                    try:
                        response = securityhub.update_findings(
                            ...
                            Note={'Text': 'Configured the load balancer to drop invalid HTTP headers and archived the finding. Review the load balancer attributes to ensure any other configuration issues are identified and remediated.','UpdatedBy': lambdaFunctionName},
