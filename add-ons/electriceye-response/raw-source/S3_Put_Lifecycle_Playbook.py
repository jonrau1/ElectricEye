    ...
    for findings in securityHubEvent:
        ...
        for resources in findings['Resources']:
            ...
            if findingOwner != masterAccountId:
                ...
                try:
                    # apply bucket lifecycle configuration
                    # move current and versioned objects to OZ_IA after 180
                    # move current and versioned objects to Glacier after 365
                    # delete current and versioned objects after 7 years (2555 days)
                    # delete multi-part fails after 24 hours
                            ...
                            'Rules': [
                                {
                                    ...
                                    'Status': 'Enabled',
                                    'Transitions': [
                                        {'Days': 180,'StorageClass': 'ONEZONE_IA'},
                                        {'Days': 365,'StorageClass': 'GLACIER'}
                                    ],
                                    'NoncurrentVersionTransitions': [
                                        {'NoncurrentDays': 180,'StorageClass': 'ONEZONE_IA'},
