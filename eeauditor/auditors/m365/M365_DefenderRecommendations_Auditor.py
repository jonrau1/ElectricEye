...
def m365_security_center_recommendations_security_controls_for_win10_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-security-controls-for-win10-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-security-controls-for-win10-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.6] Microsoft 365 Defender recommendations for Windows 10 Security Controls should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Security Controls require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win10SecurityControls",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.6] Microsoft 365 Defender recommendations for Windows 10 Security Controls should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Security Controls do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_accounts_for_win10_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-accounts-for-win10-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-accounts-for-win10-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.7] Microsoft 365 Defender recommendations for Windows 10 Accounts should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Accounts require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.7] Microsoft 365 Defender recommendations for Windows 10 Accounts should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Accounts do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_network_for_win10_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-network-for-win10-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-network-for-win10-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.8] Microsoft 365 Defender recommendations for Windows 10 Network configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Network configurations require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.8] Microsoft 365 Defender recommendations for Windows 10 Network configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Network configurations do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_os_for_win10_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-os-for-win10-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-os-for-win10-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.9] Microsoft 365 Defender recommendations for Windows 10 OS configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 OS configurations require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win10OsConfiguration",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.9] Microsoft 365 Defender recommendations for Windows 10 OS configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 OS configurations do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_network_assessment_for_win10_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-network-assessments-for-win10-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-network-assessments-for-win10-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.10] Microsoft 365 Defender recommendations for Windows 10 Network Assessments should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Network Assessments require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win10NetworkAssessments",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.10] Microsoft 365 Defender recommendations for Windows 10 Network Assessments should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 10 Network Assessments do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_security_controls_for_win11_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-security-controls-for-win11-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-security-controls-for-win11-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.11] Microsoft 365 Defender recommendations for Windows 11 Security Controls should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Security Controls require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win11SecurityControls",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.11] Microsoft 365 Defender recommendations for Windows 11 Security Controls should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Security Controls do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_accounts_for_win11_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-accounts-for-win11-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-accounts-for-win11-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.12] Microsoft 365 Defender recommendations for Windows 11 Accounts should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Accounts require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win11SAccounts",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.12] Microsoft 365 Defender recommendations for Windows 11 Accounts should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Accounts do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_network_for_win11_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-network-for-win11-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-network-for-win11-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.13] Microsoft 365 Defender recommendations for Windows 11 Network configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Network configurations require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win11SNetwork",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.13] Microsoft 365 Defender recommendations for Windows 11 Network configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Network configurations do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_os_for_win11_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-os-for-win11-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-os-for-win11-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.14] Microsoft 365 Defender recommendations for Windows 11 OS configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 OS configurations require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win11OsConfiguration",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.14] Microsoft 365 Defender recommendations for Windows 11 OS configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 OS configurations do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_network_assessment_for_win11_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-network-assessments-for-win11-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-network-assessments-for-win11-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.15] Microsoft 365 Defender recommendations for Windows 11 Network Assessments should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Network Assessments require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/Win11NetworkAssessments",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.15] Microsoft 365 Defender recommendations for Windows 11 Network Assessments should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Windows 11 Network Assessments do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_security_controls_for_linux_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-security-controls-for-linux-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-security-controls-for-linux-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.16] Microsoft 365 Defender recommendations for Linux Security Controls should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Security Controls require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/LinuxSecurityControls",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.16] Microsoft 365 Defender recommendations for Linux Security Controls should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Security Controls do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_accounts_for_linux_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-accounts-for-linux-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-accounts-for-linux-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.17] Microsoft 365 Defender recommendations for Linux Accounts should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Accounts require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/LinuxSAccounts",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.17] Microsoft 365 Defender recommendations for Linux Accounts should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Accounts do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_network_for_linux_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-network-for-linux-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-network-for-linux-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.18] Microsoft 365 Defender recommendations for Linux Network configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Network configurations require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/LinuxSNetwork",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.18] Microsoft 365 Defender recommendations for Linux Network configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Network configurations do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_os_for_linux_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-os-for-linux-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-os-for-linux-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.19] Microsoft 365 Defender recommendations for Linux OS configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux OS configurations require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/LinuxOsConfiguration",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.19] Microsoft 365 Defender recommendations for Linux OS configurations should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux OS configurations do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
...
def m365_security_center_recommendations_network_assessment_for_linux_check(cache, awsAccountId, awsRegion, awsPartition, tenantId, clientId, clientSecret, tenantLocation):
    ...
    if checkReccs:
        ...
        finding = {
            "SchemaVersion": "2018-10-08",
            "Id": f"{tenantId}/m365-security-center-recommendations-network-assessments-for-linux-check",
            "ProductArn": f"arn:{awsPartition}:securityhub:{awsRegion}:{awsAccountId}:product/{awsAccountId}/default",
            "GeneratorId": f"{tenantId}/m365-security-center-recommendations-network-assessments-for-linux-check",
            "AwsAccountId": awsAccountId,
            "Types": ["Software and Configuration Checks"],
            "FirstObservedAt": iso8601Time,
            "CreatedAt": iso8601Time,
            ...
            "Severity": {"Label": "HIGH"},
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.20] Microsoft 365 Defender recommendations for Linux Network Assessments should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Network Assessments require implementation. The following recommendations are still active: {reccSentence}. Cybersecurity weaknesses identified in your organization are mapped to actionable security recommendations and prioritized by their impact. Prioritized recommendations help shorten the time to mitigate or remediate vulnerabilities and drive compliance. Each security recommendation includes actionable remediation steps. To help with task management, the recommendation can also be sent using Microsoft Intune and Microsoft Endpoint Configuration Manager. When the threat landscape changes, the recommendation also changes as it continuously collects information from your environment. Refer to the remediation instructions if this configuration is not intended.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
            ...
            "Resources": [
                {
                    "Type": "M365DefenderRecommendation",
                    "Id": f"{tenantId}/Recommendations/LinuxNetworkAssessments",
                    "Partition": awsPartition,
                    "Region": awsRegion,
                    "Details": {
                        "Other": {
        ...
        finding = {
            ...
            "Confidence": 99,
            "Title": "[M365.DefenderRecommendations.20] Microsoft 365 Defender recommendations for Linux Network Assessments should be implemented",
            "Description": f"Microsoft 365 Defender recommendations for M365 Tenant {tenantId} regarding Linux Network Assessments do not require implementation.",
            "Remediation": {
                "Recommendation": {
                    "Text": "For more information on Security recommendations, the logic behind them, remediation guidance, and exception management refer to the Security recommendations section of the Microsoft 365 for Microsoft Defender Vulnerability Management documentation.",
                    "Url": "https://learn.microsoft.com/en-us/microsoft-365/security/defender-vulnerability-management/tvm-security-recommendation?view=o365-worldwide"
