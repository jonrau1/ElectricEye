...
def cluster_public_access_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("redshift")
def cluster_encryption_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    clusters = describe_clusters(cache=cache)
    myRedshiftClusters = clusters['Clusters']
    for cluster in myRedshiftClusters:
        clusterId = str(cluster['ClusterIdentifier'])
...
@registry.register_check("redshift")
def cluster_enhanced_vpc_routing_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    clusters = describe_clusters(cache=cache)
    myRedshiftClusters = clusters['Clusters']
    for cluster in myRedshiftClusters:
        clusterId = str(cluster['ClusterIdentifier'])
...
@registry.register_check("redshift")
def cluster_logging_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    clusters = describe_clusters(cache=cache)
    myRedshiftClusters = clusters['Clusters']
    for cluster in myRedshiftClusters:
        clusterId = str(cluster['ClusterIdentifier'])
