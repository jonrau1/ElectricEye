...
def bucket_encryption_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("s3")
def bucket_lifecycle_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    bucket = list_buckets(cache=cache)
    myS3Buckets = bucket['Buckets']
    for buckets in myS3Buckets:
        bucketName = str(buckets['Name'])
...
@registry.register_check("s3")
def bucket_versioning_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    bucket = list_buckets(cache=cache)
    myS3Buckets = bucket['Buckets']
    for buckets in myS3Buckets:
        bucketName = str(buckets['Name'])
...
@registry.register_check("s3")
def bucket_policy_allows_public_access_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    bucket = list_buckets(cache=cache)
    myS3Buckets = bucket['Buckets']
    for buckets in myS3Buckets:
        bucketName = str(buckets['Name'])
...
@registry.register_check("s3")
def bucket_policy_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    bucket = list_buckets(cache=cache)
    myS3Buckets = bucket['Buckets']
    for buckets in myS3Buckets:
        bucketName = str(buckets['Name'])
...
@registry.register_check("s3")
def bucket_access_logging_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    bucket = list_buckets(cache=cache)
    myS3Buckets = bucket['Buckets']
    for buckets in myS3Buckets:
        bucketName = str(buckets['Name'])
...
@registry.register_check("s3")
def s3_account_level_block(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
