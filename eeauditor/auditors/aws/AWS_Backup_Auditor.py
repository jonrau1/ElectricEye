...
def volume_backup_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("backup")
def ec2_backup_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("backup")
def ddb_backup_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("backup")
def reds_backup_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("backup")
def efs_backup_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
