...
def cloudtrail_multi_region_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
...
@registry.register_check("cloudtrail")
def cloudtrail_cloudwatch_logging_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    trail = list_trails(cache=cache)
    myCloudTrails = trail['Trails']
    for trails in myCloudTrails:
        trailArn = str(trails['TrailARN'])
...
@registry.register_check("cloudtrail")
def cloudtrail_encryption_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    trail = list_trails(cache=cache)
    myCloudTrails = trail['Trails']
    for trails in myCloudTrails:
        trailArn = str(trails['TrailARN'])
...
@registry.register_check("cloudtrail")
def cloudtrail_global_services_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    trail = list_trails(cache=cache)
    myCloudTrails = trail['Trails']
    for trails in myCloudTrails:
        trailArn = str(trails['TrailARN'])
...
@registry.register_check("cloudtrail")
def cloudtrail_log_file_validation_check(cache: dict, awsAccountId: str, awsRegion: str) -> dict:
    trail = list_trails(cache=cache)
    myCloudTrails = trail['Trails']
    for trails in myCloudTrails:
        trailArn = str(trails['TrailARN'])
