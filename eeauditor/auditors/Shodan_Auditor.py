...
class PublicEC2ShodanCheck(Auditor):
    def execute(self):
        try:
...
class PublicALBShodanCheck(Auditor):
    def execute(self):
        try:
...
class PublicRDSShodanCheck(Auditor):
    def execute(self):
        try:
...
class PublicESDomainShodanCheck(Auditor):
    def execute(self):
        try:
...
class PublicCLBShodanCheck(Auditor):
    def execute(self):
        try:
...
class PublicDMSReplicationInstanceShodanCheck(Auditor):
    def execute(self):
        try:
...
class PublicAmazonmqBrokerShodanCheck(Auditor):
    def execute(self):
        try:
