...
class iamAccessKeyAgeCheck(Auditor):
    def execute(self):
...
class UserPermissionsBoundaryCheck(Auditor):
    def execute(self):
        for users in allUsers:
            userName = str(users['UserName'])
            userArn = str(users['Arn'])
...
class UserInlinePolicyCheck(Auditor):
    def execute(self):
        for users in allUsers:
            userName = str(users['UserName'])
            userArn = str(users['Arn'])
...
class UserDirectAttachedPolicyCheck(Auditor):
    def execute(self):
        for users in allUsers:
            userName = str(users['UserName'])
            userArn = str(users['Arn'])
...
class CISawsFoundationsBenchmarkPWpolicyCheck(Auditor):
    def execute(self):
        try:
...
class ServerCertsCheck(Auditor):
    def execute(self):
        try:
