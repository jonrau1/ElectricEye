...
class RdsInstanceHaCheck(Auditor):
    def execute(self):
...
class RdsInstancePublicAccessCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsInstanceStorageEncryptionCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsInstanceIamAuthCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsInstanceDomainJoinCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsInstancePerformanceInsightsCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsInstanceDeletionProtectionCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsInstanceCloudwatchLoggingCheck(Auditor):
    def execute(self):
        for dbinstances in myRdsInstances:
            instanceArn = str(dbinstances["DBInstanceArn"])
            instanceId = str(dbinstances["DBInstanceIdentifier"])
...
class RdsSnapshotEncryptionCheck(Auditor):
    def execute(self):
...
class RdsSnapshotPublicShareCheck(Auditor):
    def execute(self):
        for snapshot in myRdsSnapshots:
            snapshotId = str(snapshot["DBSnapshotIdentifier"])
            snapshotArn = str(snapshot["DBSnapshotArn"])
