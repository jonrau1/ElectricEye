...
class Elbv2AlbLoggingCheck(Auditor):
    def execute(self):
...
class Elbv2DeletionProtectionCheck(Auditor):
    def execute(self):
        for loadbalancers in myElbv2LoadBalancers:
            elbv2Arn = str(loadbalancers["LoadBalancerArn"])
            elbv2Name = str(loadbalancers["LoadBalancerName"])
...
class Elbv2InternetFacingSecureListenersCheck(Auditor):
    def execute(self):
        for loadbalancers in myElbv2LoadBalancers:
            elbv2Arn = str(loadbalancers["LoadBalancerArn"])
            elbv2Name = str(loadbalancers["LoadBalancerName"])
...
class Elbv2Tls12ListenerPolicyCheck(Auditor):
    def execute(self):
        for loadbalancers in myElbv2LoadBalancers:
            elbv2Arn = str(loadbalancers["LoadBalancerArn"])
            elbv2Name = str(loadbalancers["LoadBalancerName"])
...
class Elbv2DropInvalidHeaderCheck(Auditor):
    def execute(self):
        for loadbalancers in myElbv2LoadBalancers:
            elbv2Arn = str(loadbalancers["LoadBalancerArn"])
            elbv2Name = str(loadbalancers["LoadBalancerName"])
...
class Elbv2NlbTlsLoggingCheck(Auditor):
    def execute(self):
        for loadbalancers in myElbv2LoadBalancers:
            elbv2Arn = str(loadbalancers["LoadBalancerArn"])
            elbv2Name = str(loadbalancers["LoadBalancerName"])
