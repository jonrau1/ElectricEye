...
class WorkspacesUserVolumeEncryptionCheck(Auditor):
    def execute(self):
...
class WorkspacesRootVolumeEncryptionCheck(Auditor): 
    def execute(self):
        for workspace in myWorkSpaces:
            workspaceId = str(workspace['WorkspaceId'])
            workspaceArn = 'arn:aws:workspaces:' + awsRegion + ':' + awsAccountId + ':workspace/' + workspaceId
...
class WorkspacesRunningModeCheck(Auditor):
    def execute(self):
        for workspace in myWorkSpaces:
            workspaceId = str(workspace['WorkspaceId'])
            workspaceArn = 'arn:aws:workspaces:' + awsRegion + ':' + awsAccountId + ':workspace/' + workspaceId
...
class WorkspacesDirectoryDefaultInternetCheck(Auditor):
    def execute(self):
