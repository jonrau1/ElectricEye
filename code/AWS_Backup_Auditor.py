...
def volume_backup_check():
    ...
    for volumes in myEbsVolumes:
        ...
        try:
            ...
            print('EBS volume is protected by AWS Backup')
    ...
    for reservations in myReservations:
        ...
        for instances in myInstances:
            ...
            try:
                ...
                print('EC2 instance is protected by AWS Backup')
...
def ddb_backup_check():
    ...
    for tables in myDdbTables:
        ...
        try:
                    ...
                    Findings=[
                        {
                            ...
                            'Description': 'DynamoDB table ' + tableName + ' is not protected by AWS Backup. Refer to the remediation instructions for information on ensuring disaster recovery and business continuity requirements are fulfilled for EC2 instances',
                            'Remediation': {
                                'Recommendation': {
                                    'Text': 'For information on creating scheduled backups refer to the Assign Resources to a Backup Plan section of the AWS Backup Developer Guide',
                                    'Url': 'https://docs.aws.amazon.com/aws-backup/latest/devguide/create-a-scheduled-backup.html#assign-resources-to-plan'
            ...
            print('DynamoDB table is protected by AWS Backup')
...
def rds_backup_check():
    ...
    for databases in myRdsInstances:
        ...
        try:
                    ...
                    Findings=[
                        {
                            ...
                            'Description': 'RDS database instance ' + dbId + ' is not protected by AWS Backup. Refer to the remediation instructions for information on ensuring disaster recovery and business continuity requirements are fulfilled for EC2 instances',
                            'Remediation': {
                                'Recommendation': {
                                    'Text': 'For information on creating scheduled backups refer to the Assign Resources to a Backup Plan section of the AWS Backup Developer Guide',
                                    'Url': 'https://docs.aws.amazon.com/aws-backup/latest/devguide/create-a-scheduled-backup.html#assign-resources-to-plan'
            ...
            print('RDS DB instance is protected by AWS Backup')
