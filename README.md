...
These are the following services and checks perform by each Auditor. There are currently **150** checks supported across **48** AWS services / components using **34** Auditors. There are currently **32** supported response and remediation Playbooks with coverage across **23** AWS services / components supported by ElectricEye-Response.
