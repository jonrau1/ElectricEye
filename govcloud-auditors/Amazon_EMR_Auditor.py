...
class EmrClusterSecurityConfigurationCheck(Auditor):
    def execute(self):
...
class EmrSecurityConfigEncryptionInTransitCheck(Auditor):
    def execute(self):
        for cluster in myEmrClusters:
            clusterId = str(cluster["Id"])
            try:
...
class EmrSecurityConfigEncryptionAtRestCheck(Auditor):
    def execute(self):
        for cluster in myEmrClusters:
            clusterId = str(cluster["Id"])
            try:
...
class EmrSecurityConfigConfigEbsEncryptionCheck(Auditor):
    def execute(self):
        for cluster in myEmrClusters:
            clusterId = str(cluster["Id"])
            try:
...
class EmrSecurityConfigKerberosCheck(Auditor):
    def execute(self):
        for cluster in myEmrClusters:
            clusterId = str(cluster["Id"])
            try:
...
class EmrClusterTerminationProtectionCheck(Auditor):
    def execute(self):
        for cluster in myEmrClusters:
            clusterId = str(cluster["Id"])
            try:
...
class EmrClusterLoggingCheck(Auditor):
    def execute(self):
        for cluster in myEmrClusters:
            clusterId = str(cluster["Id"])
            try:
...
class EmrClusterBlockSecgroupCheck(Auditor):
    def execute(self):
        try:
