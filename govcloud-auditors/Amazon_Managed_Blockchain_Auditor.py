...
class AmbFabricNodeChaincodeLoggingCheck(Auditor):
    def execute(self):
                    ...
                    try:
                        ...
                        for nodes in response["Nodes"]:
                            ...
                            try:
                                ...
                                nodeArn = (
                                    "arn:aws-us-gov:managedblockchain:"
                                    + awsRegion
                                    + ":"
                                    + awsAccountId
                                    + ":nodes/"
...
class AmbFabricNodePeernodeLoggingCheck(Auditor):
    def execute(self):
        for networks in myFabricNetworks:
            fabricNetworkId = str(networks["Id"])
            try:
...
class AmbFabricMemberCaLoggingCheck(Auditor):
    def execute(self):
        for networks in myFabricNetworks:
            fabricNetworkId = str(networks["Id"])
            try:
