...
class CloudtrailMultiRegionCheck(Auditor):
    def execute(self):
        for trails in myCloudTrails:
            trailArn = str(trails["TrailARN"])
            trailName = str(trails["Name"])
            response = cloudtrail.describe_trails(
                trailNameList=[trailArn], includeShadowTrails=False
            )
            iso8601Time = (
...
class CloudtrailCloudwatchLoggingCheck(Auditor):
    def execute(self):
        for trails in myCloudTrails:
            trailArn = str(trails["TrailARN"])
            trailName = str(trails["Name"])
...
class CloudtrailEncryptionCheck(Auditor):
    def execute(self):
        for trails in myCloudTrails:
            trailArn = str(trails["TrailARN"])
            trailName = str(trails["Name"])
...
class CloudtrailGlobalServicesCheck(Auditor):
    def execute(self):
        for trails in myCloudTrails:
            trailArn = str(trails["TrailARN"])
            trailName = str(trails["Name"])
...
class CloudtrailLogFileValidationCheck(Auditor):
    def execute(self):
        for trails in myCloudTrails:
            trailArn = str(trails["TrailARN"])
            trailName = str(trails["Name"])
