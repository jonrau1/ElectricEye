...
if awsRegion != "us-east-1":
    ...
    class ShieldAdvancedRoute53ProtectionCheck(Auditor):
        def execute(self):
    ...
    class ShieldAdvancedELBProtectionCheck(Auditor):
        def execute(self):
    ...
    class ShieldAdvancedELBV2ProtectionCheck(Auditor):
        def execute(self):
    ...
    class ShieldAdvancedEIPProtectionCheck(Auditor):
        def execute(self):
            response = ec2.describe_addresses()
            for elasticip in response["Addresses"]:
                # arn:aws-us-gov:ec2:${aws-us-gov::Region}:${aws-us-gov::AccountId}:eip/${EIP1.AllocationId}
    ...
    class ShieldAdvancedCloudfrontProtectionCheck(Auditor):
        def execute(self):
    ...
    class ShieldAdvancedDRTAccessCheck(Auditor):
        def execute(self):
            ...
            try:
                ...
                finding = {
                    ...
                    "Resources": [
                        {
                            "Type": "AwsAccount",
                            "Id": "aws-us-gov::::Account:" + awsAccountId,
                            "Partition": "aws-us-gov",
                            "Region": awsRegion,
                        }
                    ],
    ...
    class ShieldAdvancedDRTs3bucketCheck(Auditor):
        def execute(self):
            response = shield.describe_drt_access()
            iso8601Time = (
                datetime.datetime.utcnow()
    ...
    class ShieldAdvancedSubscriptionAutorenewCheck(Auditor):
        def execute(self):
