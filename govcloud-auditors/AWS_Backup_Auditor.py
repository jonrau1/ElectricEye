...
class VolumeBackupCheck(Auditor):
    def execute(self):
...
class efsBackupCheck(Auditor):
    def execute(self):
        ...
        for filesys in myFileSys:
            ...
            fileSysArn = (
                "arn:aws-us-gov:elasticfilesystem:"
                + awsRegion
                + ":"
                + awsAccountId
                + ":file-system/"
