...
class InternetFacingClbHttpsListenerCheck(Auditor):
    def execute(self):
...
class ClbHttpsListenerTls12PolicyCheck(Auditor):
    def execute(self):
        # loop through classic load balancers
        response = elb.describe_load_balancers()
        for classicbalancer in response["LoadBalancerDescriptions"]:
...
class ClbCrossZoneBalancingCheck(Auditor):
    def execute(self):
        # loop through classic load balancers
        response = elb.describe_load_balancers()
        for classicbalancer in response["LoadBalancerDescriptions"]:
...
class ClbConnectionDrainingCheck(Auditor):
    def execute(self):
        # loop through classic load balancers
        response = elb.describe_load_balancers()
        for classicbalancer in response["LoadBalancerDescriptions"]:
...
class ClbAccessLoggingCheck(Auditor):
    def execute(self):
        # loop through classic load balancers
        response = elb.describe_load_balancers()
        for classicbalancer in response["LoadBalancerDescriptions"]:
