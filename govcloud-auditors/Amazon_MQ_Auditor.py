...
class BrokerKmsCmkCheck(Auditor):
    def execute(self):
...
class BrokerAuditLoggingCheck(Auditor):
    def execute(self):
        for broker in myBrokers:
            brokerName = str(broker["BrokerName"])
            try:
...
class BrokerGeneralLoggingCheck(Auditor):
    def execute(self):
        for broker in myBrokers:
            brokerName = str(broker["BrokerName"])
            try:
...
class BrokerPublicAccessCheck(Auditor):
    def execute(self):
        for broker in myBrokers:
            brokerName = str(broker["BrokerName"])
            try:
...
class BrokerMinorVersionAutoUpgradeCheck(Auditor):
    def execute(self):
        for broker in myBrokers:
            brokerName = str(broker["BrokerName"])
            try:
