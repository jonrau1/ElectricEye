    ...
    def execute(self):
        for restapi in myRestApis:
            ...
            for apistages in response["item"]:
                ...
                try:
                    metricsCheck = str(
                        apistages["methodSettings"]["*/*"]["metricsEnabled"]
                    )
                except KeyError:
                    metricsCheck = "False"
                if metricsCheck == "False":
                    try:
                        ...
                        finding = {
                            ...
                            "Id": apiStageArn
                            + "/apigateway-stage-metrics-enabled-check",
    ...
    def execute(self):
        for restapi in myRestApis:
            ...
            for apistages in response["item"]:
                ...
                try:
                    loggingCheck = str(
                        apistages["methodSettings"]["*/*"]["loggingLevel"]
                    )
                except KeyError:
                    loggingCheck = "OFF"
                if loggingCheck == "OFF":
                    try:
                        ...
                        finding = {
                            "SchemaVersion": "2018-10-08",
                            "Id": apiStageArn
                            + "/apigateway-stage-api-logging-enabled-check",
                            "ProductArn": "arn:aws-us-gov:securityhub:"
                            + awsRegion
                            + ":"
                            + awsAccountId
    ...
    def execute(self):
        for restapi in myRestApis:
            ...
            for apistages in response["item"]:
                ...
                try:
                    cachingCheck = str(
                        apistages["methodSettings"]["*/*"]["cachingEnabled"]
                    )
                except KeyError:
                    cachingCheck = "False"
                if cachingCheck == "False":
                    try:
                        ...
                        finding = {
                            "SchemaVersion": "2018-10-08",
                            "Id": apiStageArn
                            + "/apigateway-stage-caching-enabled-check",
                            "ProductArn": "arn:aws-us-gov:securityhub:"
                            + awsRegion
                            + ":"
                            + awsAccountId
                ...
                if cachingEncryptionCheck == "False":
                    try:
                        ...
                        finding = {
                            "SchemaVersion": "2018-10-08",
                            "Id": apiStageArn
                            + "/apigateway-stage-cache-encryption-check",
                            "ProductArn": "arn:aws-us-gov:securityhub:"
                            + awsRegion
                            + ":"
                            + awsAccountId
                ...
                try:
                    ...
                    try:
                        ...
                        finding = {
                            "SchemaVersion": "2018-10-08",
                            "Id": apiStageArn
                            + "/apigateway-stage-waf-protection-check",
                            "ProductArn": "arn:aws-us-gov:securityhub:"
                            + awsRegion
                            + ":"
                            + awsAccountId
