...
class ClusterEncryptionCheck(Auditor):
    def execute(self):
        for cluster in myRedshiftClusters:
            clusterId = str(cluster["ClusterIdentifier"])
            clusterArn = (
...
class ClusterEnhancedVPCRoutingCheck(Auditor):
    def execute(self):
        for cluster in myRedshiftClusters:
            clusterId = str(cluster["ClusterIdentifier"])
            clusterArn = (
...
class ClusterLoggingCheck(Auditor):
    def execute(self):
        for cluster in myRedshiftClusters:
            clusterId = str(cluster["ClusterIdentifier"])
            clusterArn = (
